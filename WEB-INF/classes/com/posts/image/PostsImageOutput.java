...
public class PostsImageOutput extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String postsID = req.getParameter("postsID");
			ResultSet rs = stmt.executeQuery(
				"select postsImg from posts where postsID="+postsID);
